      ...
      <main className="flex-grow pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full">
        <div className="text-slate-600 [&_h1]:text-4xl [&_h1]:font-bold [&_h1]:mb-8 [&_h1]:text-[#0F172A] [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:mt-10 [&_h2]:mb-4 [&_h2]:text-[#0F172A] [&_h3]:text-xl [&_h3]:font-semibold [&_h3]:mt-8 [&_h3]:mb-4 [&_h3]:text-[#0F172A] [&_p]:mb-5 [&_p]:leading-relaxed [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-6 [&_li]:mb-2 [&_li>p]:mb-2 [&_a]:text-[#3b82f6] [&_a]:hover:underline [&_strong]:font-semibold [&_strong]:text-[#0F172A]">
          ...
          <ul>
            ...
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to vertexgrid.one, 822 E. 20th Street Los Angeles CA .</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to vertexgrid.one, accessible from <a href="https://vertexgrid.one/" rel="external nofollow noopener noreferrer" target="_blank" className="text-blue-600 hover:underline">https://vertexgrid.one/</a></p>
            </li>
            <li>
